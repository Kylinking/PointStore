    ...
    it('it should return 3 users', (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body.Array.should.have.length(3);
                done();
            });
    });
});
    ...
    it('it should return 4 user', (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body.should.have.property('Array');
                res.body.Array.should.be.a('array');
                res.body.Array.should.have.length(4);
                done();
            });
    });
});
    ...
    it('it should create a customerinfo and return info', (done) => {
        ...
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body.Object.should.have.property('CustomerId');
                res.body.Object.should.have.property('Name');
                res.body.Object.should.have.property('Sex');
                res.body.Object.should.have.property('Age');
    ...
    it('it should create a customerinfo and return info', (done) => {
        ...
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body.Object.should.have.property('Status');
                res.body.Object.should.have.property('Phone');
                res.body.Object.Status.should.eq(0);
                done();
            });
    });
});
    ...
    it('it should create a customerinfo and return info', (done) => {
        ...
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body.Object.should.have.property('Status');
                res.body.Object.should.have.property('Phone');
                res.body.Object.Status.should.eq(1);
                done();
            });
    });
});
